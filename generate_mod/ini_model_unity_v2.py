...
class M_UnityIniModelV2:
    ...
    @classmethod
    def add_unity_cs_texture_override_ib_sections(cls,config_ini_builder:M_IniBuilder,commandlist_ini_builder:M_IniBuilder,draw_ib_model:DrawIBModelUniversal):
        texture_override_ib_section = M_IniSection(M_SectionType.TextureOverrideIB)
        draw_ib = draw_ib_model.draw_ib
        d3d11GameType = draw_ib_model.d3d11GameType
    ...
    @classmethod
    def add_unity_cs_resource_vertexlimit(cls,commandlist_ini_builder:M_IniBuilder,draw_ib_model:DrawIBModelUniversal):
        '''
