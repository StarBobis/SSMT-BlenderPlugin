...
def get_buffer_ib_vb_fast(d3d11GameType:D3D11GameType):
    ...
    if GlobalConfig.gamename == "GF2" and "TANGENT" in buffer_model.d3d11GameType.OrderedFullElementList:
        ib, category_buffer_dict,index_vertex_id_dict = buffer_model.calc_index_vertex_buffer_girlsfrontline2(obj, mesh)
        ...
        ib, category_buffer_dict,index_vertex_id_dict = buffer_model.calc_index_vertex_buffer(obj, mesh)
        return ib, category_buffer_dict,index_vertex_id_dict
