...
class M_IniBuilder:
    ...
    def save_to_file(self,config_ini_path:str):
        ...
        # 也许这两行加上会很有趣
        # self.line_list.append("; .ini generated by XXMI (XX-Model-Importer)\n")
        # self.line_list.append("; If you have any issues or find any bugs, please open a ticket at https://github.com/leotorrez/XXMI-Tools/issues\n\n")
